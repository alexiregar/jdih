                ...
                <div class="col-lg-4 col-sm-6 sm-margin-40px-bottom">
                    ...
                    <ul class="list-style-1 no-margin">
                        <li>
                            ...
                            <span class="d-inline-block width-65 sm-width-85 vertical-align-top padding-10px-left">Perpustakaan Ganti Nama Instansi</span>
			    <span class="d-inline-block width-65 sm-width-85 vertical-align-top padding-35px-left">Ganti alamat instansi</span>
                        </li>
                        <li>
    ...
    <div class="footer-bar xs-padding-15px-tb" style="background: linear-gradient(to bottom, #ff9900 0%, #ff6600 44%)">
        <div class="container">
            ...
            <div class="float-left xs-width-100 text-center">
                <p class="text-medium-black font-weight-600 margin-5px-top xs-no-margin-top">&copy; 2020 All Rights Reserved by <a class="text-black" href="#">Diskominfo Kab. Paluta</a></p>
            </div>
        </div>
    </div>
</footer>
